...
import { faUser, faCircleQuestion , faGear, faFlaskVial } from '@fortawesome/free-solid-svg-icons';
	...
	return(
		<div className="Dropdown">
			...
			<div className='content'>
				...
				<a className='item' href='/experimental'><FontAwesomeIcon icon={faFlaskVial}/>Experimental</a>
